...
fs.writeFileSync(path.join(distDir, 'build-meta.json'), JSON.stringify({ builtAt: new Date().toISOString(), app: 'Institutional Pair Rebalancer v8', runtimeStartCommand: 'node server.mjs' }, null, 2));
